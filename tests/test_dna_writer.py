...
#                                                            '} NodeTexMagic;\n'
#                                                            '\n'
#                                                            'typedef struct NodeTexNodeName {NodeTexBase base;int dropdown1, dropdown2, int1, box1, box2;char _pad[4];} NodeTexNodeName;\n'
#                                                            '\n'
#                                                            'typedef struct NodeShaderAttribute {\n'
#                                                            '  char name[64];\n'
#                                                            '} NodeShaderAttribute;\n\n'
...
#         props = [
#             {"name": "int1", 'data-type': IntProp(), "sub-type": "PROP_NONE", "default": 0, "min": -1, "max": 1},
#             {"name": "int2", 'data-type': IntProp(), "sub-type": "PROP_NONE", "default": 0, "min": -1, "max": 1},
#             {"name": "box1", 'data-type': BoolProp(), "sub-type": "PROP_NONE", "default": 0},
...
#                                                            '} NodeTexMagic;\n'
#                                                            '\n'
#                                                            'typedef struct NodeNodeName {int int1, int2, box1, box2;char _pad[4];} NodeNodeName;\n'
#                                                            '\n'
#                                                            'typedef struct NodeShaderAttribute {\n'
#                                                            '  char name[64];\n'
#                                                            '} NodeShaderAttribute;\n\n'
